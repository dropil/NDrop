...
{
    public class Undelegate : Msg, IMsg
    {
        public Undelegate() { }

        public Undelegate(Network network, Coin amount, string delegator_address, string validator_address,
            string account_number = null, string sequence = null, string memo = "",
            string fee = null, string gas = null)
        {
            // required params
            this.msgType = MsgType.Undelegate;
